var MPromise = (function() {
  function MPromise(resolver) {
      if (typeof resolver !== 'function') { //resolver必须是函数
          throw new TypeError('MPromise resolver ' + resolver + ' is not a function')
      }
      if (!(this instanceof MPromise)) return new MPromise(resolver)
  ...
  function resolveMPromise(promise, x, resolve, reject) {
      var then
          ...
          try {
              ...
              if (typeof then === 'function') {
                  then.call(x, function rs(y) {
                      ...
                      return resolveMPromise(promise, y, resolve, reject)
                  }, function rj(r) {
                      if (thenCalledOrThrow) return
                      thenCalledOrThrow = true
                      return reject(r)
          ...
          return promise2 = new MPromise(function(resolve, reject) {
              setTimeout(function() {
                  try {
                      ...
                      //根据x的值修改promise2的状态
                      resolveMPromise(promise2, x, resolve, reject)
                  } catch(e) {
  ...
  //获取当前MPromise传递的值
  MPromise.prototype.valueOf = function() {
      return this.data
  }
  ...
  MPromise.prototype.spread = function(fn, onRejected) {
      return this.then(function(values) {
          return fn.apply(null, values)
      }, onRejected)
  }

  MPromise.prototype.inject = function(fn, onRejected) {
      return this.then(function(v) {
  ...
  MPromise.prototype.delay = function(duration) {
  ...
  MPromise.all = function(promises) {
      return new MPromise(function(resolve, reject) {
          ...
          for (var i = 0; i < promiseNum; i++) {
              (function(i) {
                  MPromise.resolve(promises[i]).then(function(value) {
                      resolvedCounter++
  ...
  MPromise.resolve = function(value) {
      var promise = new MPromise(function(resolve, reject) {
          resolveMPromise(promise, value, resolve, reject)
      })
      return promise
  }
  ...
  MPromise.fcall = function(fn){
      // 虽然fn可以接收到上一层then里传来的参数，但是其实是undefined，所以跟没有是一样的，因为resolve没参数啊
      return MPromise.resolve().then(fn)
  }

  MPromise.done = MPromise.stop = function(){
      return new MPromise(function(){})
  }
